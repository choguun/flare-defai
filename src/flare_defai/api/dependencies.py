...
from flare_defai.blockchain.flare import FlareService
...
# Singleton instances
_flare_service: Optional[FlareService] = None
_explorer_service: Optional[BlockExplorerService] = None
_ai_provider: Optional[GeminiAIProvider] = None
...
def get_transaction_validator(
    flare_service: FlareService = Depends(get_flare_service),
    explorer_service: BlockExplorerService = Depends(get_explorer_service),
    ai_provider: GeminiAIProvider = Depends(get_ai_provider),
