...
const ChatInterface = () => {
  const [messages, setMessages] = useState([
    { 
      text: "Hi, I'm Flare DeFAI! 👋 I'm your Copilot for Flare, ready to help you with operations like generating wallets, sending tokens, and executing token swaps. \n\n⚠️ While I aim to be accurate, never risk funds you can't afford to lose.",
      type: 'bot' 
    }
  ]);
    ...
    <div className="flex flex-col h-screen bg-gray-100">
      <div className="flex flex-col h-full max-w-4xl mx-auto w-full shadow-lg bg-white">
        ...
        <div className="bg-pink-600 text-white p-4">
          <h1 className="text-xl font-bold">Flare DeFAI</h1>
